          ...
          <ul>
            ...
            <li data-transition="zoomout"
              ...
              <div class="col-lg-8 fondo-blanco ow-description">
              	...
              	<div class="info-ow">
              		<h1 style="text-transform: uppercase;"><?php echo $lang['homeCorte1']; ?></h1>
              		<h3 style="text-transform: uppercase;"><?php echo $lang['homeValle']; ?></h3>
              		<h5><?php echo $lang['especialidadesCorteDeCampoTitulo']; ?></h5>
					        <p><?php echo $lang['especialidadesCorteDeCampo']; ?></p>
