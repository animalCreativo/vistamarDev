    ...
    <section class="section-wrap-mp pad-top-20">
      <div class="container">
        <div class="row mt-minus-30">
          ...
          <div class="sobrepuesto paddingTop10">
					<div class="imgbotella">
						<img src="img/23srmaen.png" class="img-center img-responsive centrar-div-pos" alt="SEPIA RESERVA MALBEC">
					</div>
				</div> <!-- end col -->
        ...
        <div class="vari"><a href="sepia_cs.php"><h4><?php echo $lang['cabernetBlend']; ?></h4></a></div>
              ...
              <div class="dot3">·</div>
              <div class="vari"><a href="sepia_ma.php"><h4 style="color: black;"><?php echo $lang['malbec']; ?></h4></a></div>
              <div class="dot3">·</div>
        ...
        <div class="vari"><a href="sepia_ch.php"><h4><?php echo $lang['chardonnay']; ?></h4></a></div>
            ...
            <div class="info-ow mt-30">
              ...
              <a href="http://www.cavamorande.cl/store/sepia-reserva/sepia-reserva-malbec-2015" target="_blank" class="btn btn-lg btn-color">
              <?php echo $lang['buy']; ?></a>
              <?php
              }
              ?> 
