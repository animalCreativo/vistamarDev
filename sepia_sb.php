    ...
    <section class="section-wrap-mp pad-top-20">
      <div class="container">
        ...
        <div class="vari"><a href="sepia_ch.php"><h4><?php echo $lang['chardonnay']; ?></h4></a></div>
              ...
              <div class="dot3">·</div>
              <div class="vari"><a href="sepia_sb.php"><h4 style="color: black;"><?php echo $lang['sauvignonBlanc']; ?></h4></a></div>
              </div>
              </div>
            ...
            <div class="info-ow mt-30">
              ...
              <a href=" http://www.cavamorande.cl/store/sepia-reserva/sepia-reserva-sauvignon-blanc-2015" target="_blank" class="btn btn-lg btn-color">
              <?php echo $lang['buy']; ?></a>
              <?php
              }
              ?> 
