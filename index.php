...
<body>
	<div class="contenedor">
    	...
    	<div class="importante">
            ...
            <div class="parrafos">
            	<span id="secreto"><?php echo $lang['secret1']; ?> <br><?php echo $lang['secret2']; ?> </span>
                
            </div>
            <div class="botones">
            	<a href="home.php" target="_self"><div class="btn-si m-right"><?php echo $lang['yes']; ?>
                </div></a>
                <a class="demo-2"><div class="btn-si"><?php echo $lang['no']; ?></div>
                </a>
                <div id="popup1">
                <img style="margin: auto; max-width: 100%; height: auto; display: block;" src="img/18-plus.png" alt="18 y más" >
                <h1 class="popup-text"><?php echo $lang['wrong1']; ?></h1>
                <h3 class="popup-text"><?php echo $lang['wrong2']; ?></h3>
            </div>
            </div>
            <!--
            <div class="parrafos">
