      ...
      <div class="container">
        <div class="row mt-minus-30">
          ...
          <div class="sobrepuesto paddingTop10">
					<div class="imgbotella">
						<img src="img/15brroen.png" class="img-center img-responsive centrar-div-pos" alt="BRISA ROSÉ" style="height: 700px; width: auto;">
					</div>
				</div> <!-- end col -->
        ...
        <div class="vari"><a href="brisa_ro.php"><h4><?php echo $lang['rose']; ?></h4></a></div>
            ...
            <div class="info-ow mt-30">
              <h1 style="text-transform: uppercase"><?php echo $lang['rose']; ?></h1>
              <br>
              <h3><?php echo $lang['origen']; ?></h3>
              <h5><?php echo $lang['valleCentral']; ?>l</h5>
              <?php echo $lang['degustacion']; ?>
              <br>
              <h6><?php echo $lang['vinificacion']; ?></h6>
              <?php echo $lang['brisa_roTexto1']; ?>
              <br><br>
              <h6><?php echo $lang['degustación']; ?></h6>
              <h3><?php echo $lang['color']; ?>:</h3> <?php echo $lang['brisa_roTexto2']; ?>
              <h3><?php echo $lang['aroma']; ?>:</h3> <?php echo $lang['brisa_roTexto3']; ?>
              <h3><?php echo $lang['sabor']; ?>:</h3> <?php echo $lang['brisa_roTexto4']; ?>
              <h3><?php echo $lang['temp']; ?>:</h3> <?php echo $lang['brisa_roTexto5']; ?>
              <h3><?php echo $lang['maridaje']; ?>:</h3> <?php echo $lang['brisa_roTexto6']; ?>
              <br><br>

              <?php 
              if ($_SESSION['lang']=='en') {  ?>
              <a href="files/Brisa/ENG/Brisa_Ro_17.pdf" target="_blank" class="btn btn-lg btn-color"><?php echo $lang['download']; ?></a>
              <?php
              }
              else if ($_SESSION['lang']=='es') { ?>
              <a href="files/Brisa/ESP/Brisa_Ro_17.pdf" target="_blank" class="btn btn-lg btn-color"><?php echo $lang['download']; ?></a>
              <a href="http://www.cavamorande.cl/store/vistamar-brisa-cabernet-sauvignon-syrah-rose-2015?search=brisa" target="_blank" class="btn btn-lg btn-color">
              <?php echo $lang['buy']; ?></a>
              <?php
              }
              ?> 
