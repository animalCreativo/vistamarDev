        ...
        <div class="row mt-minus-30">
          ...
          <div class="sobrepuesto paddingTop10">
					<div class="imgbotella">
						<img src="img/24srmeen.png" class="img-center img-responsive centrar-div-pos" alt="SEPIA RESERVA MERLOT">
					</div>
				</div> <!-- end col -->
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              <h3>Origin</h3>
              <h5>Maipo Valley</h5>
              Deep loamy-clay soils, alluvial in origin. Semi-arid Mediterranean climate, with wide temperature range which makes for a perfect ripening of the grapes.
              </p>
              <br>
              <h6>Viniﬁcation</h6>
              ...
              <br><br>
              <h3>Harvesting:</h3> Second week of March.
              <h3>Ageing:</h3> 10-12 months in barrels of French and American oak.
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Deep cherry-red, with violet highlights.
              <h3>Aroma:</h3> Red fruits, blackberries and fresh plums, with pleasant notes of vanilla.
              <h3>Flavour:</h3> Ripe red and black fruit, silken tannins and long, pleasant finish.
              <h3>Serving at:</h3> 16-18ºC.
              <h3>Food match:</h3> Brie and Camembert cheeses, terrines, pastas with tomato-based sauce.
              <br><br>
              <a href="files/24_Sepia_Me_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
              <a href="http://www.cavamorande.cl/store/sepia-reserva/sepia-reserva-merlot-2014" target="_blank" class="btn btn-lg btn-color">Buy</a>
            </div>
          </div> <!-- end col -->   
