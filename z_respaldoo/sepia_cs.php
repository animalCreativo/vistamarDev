        ...
        <div class="row mt-minus-30">
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              Soils are alluvial-colluvial in origin, of loam to loamy-clayey silt, stony and with good drainage. The climate is temperate Mediterranean with a wide temperature variation between day and night.
              </p>
              <br>
              <h6>Viniﬁcation</h6>
              Temperatures during the ripening period were lower than last year, helping the grapes to ripen slowly, with balanced acidities and better phenolic ripeness in the red varieties. During April, temperatures were cooler, resulting in fruitier wines with moderate degrees of alcohol.
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Deep red with violet highlights.
              <h3>Aroma:</h3> Fresh red and black fruits, vanilla, black pepper, and touches of fines herbes.
              <h3>Flavour:</h3> Fruity, with notes of tofee and vanilla, mild tannins, elegant and persistent.
              <h3>Serving at:</h3> 16-18ºC.
              <h3>Food match:</h3> Game, boar, venison and red meats in general.
              <br><br>
              <a href="files/21_Sepia_Cs_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
              <a href="http://www.cavamorande.cl/store/sepia-reserva/sepia-reserva-cabernet-sauvignon-2015" target="_blank" class="btn btn-lg btn-color">Buy</a>
            </div>
          </div> <!-- end col -->   
