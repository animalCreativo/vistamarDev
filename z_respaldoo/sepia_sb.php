        ...
        <div class="row mt-minus-30">
          ...
          <div class="sobrepuesto paddingTop10">
					<div class="imgbotella">
						<img src="img/27srsben.png" class="img-center img-responsive centrar-div-pos" alt="SEPIA RESERVA SAUVIGNON BLANC">
					</div>
				</div> <!-- end col -->
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              Soils are granitic on the plains and clayey on the hillsides. The climate is greatly influenced by the Pacific Ocean, ensuring that grapes ripen slowly.
              </p>
              <br>
              <h6>Viniﬁcation</h6>
              In the season, weather conditions were excellent, with no rainfall while the vines were in flower or during harvesting, and with hotter temperatures towards the end of the season. Thanks to these conditions, the grapes were able to ripen healthily and the wines obtained have balanced acidity and highly concentrated aromas and flavours.
              <br><br>
              <h3>Harvesting:</h3> Last week in March.
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Pale yellow shining with greenish highlights.
              <h3>Aroma:</h3> Intense, expressive aromas of tropical fruits, mixed with light herbal touches and citrus fruits.
              <h3>Flavour:</h3> It retains all the fresh fruitiness of its aromas, with a juicy acidity that is a constant companion from start to finish. A light body and long finish.
              <h3>Serving at:</h3> 8-10ºC.
              <h3>Food match:</h3> Sashimi, oysters, ceviche, goat cheese and fish.
              <br><br>
              <a href="files/27_Sepia_Sb_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
              <a href="http://www.cavamorande.cl/store/sepia-reserva/sepia-reserva-sauvignon-blanc-2015" target="_blank" class="btn btn-lg btn-color">Buy</a>
            </div>
          </div> <!-- end col -->   
