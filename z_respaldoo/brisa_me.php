        ...
        <div class="row mt-minus-30">
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Bright red with violet highlights.
              <h3>Aroma:</h3> Fresh and fruity with a delicate touch of spice.
              <h3>Flavour:</h3> Fresh plums, with friendly tannins, and juicy, balanced acidity.
              <h3>Serving temperature:</h3> 16-18°C.
              <h3>Food match:</h3> Vegetable bakes, pizzas and pastas with tomato-based sauces.
              <br><br>
              <a href="files/13_Brisa_Me_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
              <a href="http://www.cavamorande.cl/store/vina-vistamar/vistamar-brisa-merlot-2014" target="_blank" class="btn btn-lg btn-color">Buy</a>
            </div>
          </div> <!-- end col -->   
