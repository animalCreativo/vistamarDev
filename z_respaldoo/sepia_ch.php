        ...
        <div class="row mt-minus-30">
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              The soils are granitic on the plains and clayey on the hillsides, while the climate is strongly influenced by the Pacific Ocean, ensuring that the grapes ripen slowly.
              </p>
              <br>
              <h6>Viniﬁcation</h6>
              The season was colder than a normal year, causing some frosts in the early stages of development, which resulted in low yields while at the same time making for fruitier profiles and good acidity.
              <br><br>
              <h3>Harvesting:</h3> First week in April.
              <h3>Ageing:</h3> 8 months in barrels of French oak.
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Shining pale yellow with greenish hues.
              <h3>Aroma:</h3> Very intense fruit, with emphasis on the citrusy notes and mineral touches, and delicate hints of vanilla.
              <h3>Flavour:</h3> Fresh, natural acidity makes the wine very vivacious and fruity: it has a medium body and a long, creamy finish.
              <h3>Serving at:</h3> 8-10ºC.
              <h3>Maridaje:</h3> Ideal with seafood, vegetable stews and white meat.
              <br><br>
              <a href="files/25_Sepia_Ch_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
