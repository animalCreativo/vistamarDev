        ...
        <div class="row mt-minus-30">
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              <br>
              <h6>Viniﬁcation</h6>
              The grapes from which this wine is made come from different micro-climates in the Central  Valley, producing an expressive combination of aromas and ﬂavours. The result is a fresh, smooth and very fruity wine.
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Shining pale yellow.
              <h3>Aroma:</h3> Delicate notes of pinapple and white peaches, with notes of white ﬂowers.
              <h3>Flavour:</h3> Intensely fruity, with delicious acidity and a lovely texture.
              <h3>Serving temperature:</h3> 8° C.
              <h3>Food match:</h3> Lean ﬁsh, green salads or as an aperitif.
              <br><br>
              <a href="files/17_Brisa_SB_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
              <a href="http://www.cavamorande.cl/store/vistamar-brisa/vistamar-brisa-sauvignon-blanc-2015" target="_blank" class="btn btn-lg btn-color">Buy</a>
            </div>
          </div> <!-- end col -->   
