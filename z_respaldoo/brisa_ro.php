        ...
        <div class="row mt-minus-30">
          ...
          <div class="sobrepuesto paddingTop10">
					<div class="imgbotella">
						<img src="img/15brroen.png" class="img-center img-responsive centrar-div-pos" alt="BRISA ROSÉ">
					</div>
				</div> <!-- end col -->
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              <h1 style="text-transform: uppercase">Rosé</h1>
              <br>
              <h3>Origin</h3>
              <h5>Central Valley</h5>
              This valley is characterised by a temperate, Mediterranean-type climate with a huge temperature range. The soils vary from loose sand to clay, with variable conditions as regards stone content, humidity and altitude.</p>
              <br>
              <h6>Viniﬁcation</h6>
              The viniﬁcation aims to enhance the ﬂavours and aromas typical of the variety, obtaining fresh, fruity wines with mild, kindly tannins.
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Pale, shining yellow.
              <h3>Aroma:</h3> Sweet fruits, quince, with touches of white ﬂowers.
              <h3>Flavour:</h3> Sweet, medium body and pleasant acidity.
              <h3>Serving temperature:</h3> 8° C to 10° C.
              <h3>Food match:</h3> Uncooked shellﬁsh, ceviches and Japanese dishes.
              <br><br>
              <a href="files/15_Brisa_Ro_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
              <a href="http://www.cavamorande.cl/store/vistamar-brisa/vistamar-brisa-cabernet-sauvignon-syrah-rose-2015" target="_blank" class="btn btn-lg btn-color">Buy</a>
            </div>
          </div> <!-- end col -->   
