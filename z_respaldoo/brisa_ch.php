        ...
        <div class="row mt-minus-30">
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              <br>
              <h6>Viniﬁcation</h6>
              This wine combines the great expression of aromas and ﬂavours of grapes that come from different microclimates in the Central Valley, obtaining a fresh, smooth and very fruity wine.
              <br><br>
              <h6>Degustation</h6>
              <h3>Colour:</h3> Pale, shining yellow.
              <h3>Aroma:</h3> Clean and fruity, with predominance of ripe pears and delicate citrusy notes.
              <h3>Flavour:</h3> Fruity, fresh, rounded and enveloping.
              <h3>Serving temperature:</h3> 8-10°C.
              <h3>Food match:</h3> Chicken or turkey, crustaceans au gratin and ﬁsh with creamy sauces.
              <br><br>
              <a href="files/16_Brisa_Ch_eng.pdf" target="_blank" class="btn btn-lg btn-color">Download file</a>
              <a href="http://www.cavamorande.cl/store/vistamar-brisa/vistamar-brisa-chardonnay-2015" target="_blank" class="btn btn-lg btn-color">Buy</a>
            </div>
          </div> <!-- end col -->   
