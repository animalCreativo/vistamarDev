        ...
        <div class="row mt-minus-30">
          ...
          <div class="sobrepuesto paddingTop10">
					<div class="imgbotella">
						<img src="img/11brcsen.png" class="img-center img-responsive centrar-div-pos" alt="BRISA CABERNET SAUVIGNON" style="height: 900px; width: auto;">
					</div>
				</div> <!-- end col -->
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              <h3><?php echo $lang['temp']; ?>:</h3> <?php echo $lang['brisa_csTexto6']; ?>
              <h3><?php echo $lang['maridaje']; ?>:</h3> <?php echo $lang['brisa_csTexto7']; ?>
              <br><br>
           
              <?php 
              if ($_SESSION['lang']=='en') {  ?>
              <a href="files/Brisa/ENG/Brisa_CS_16.pdf" target="_blank" class="btn btn-lg btn-color"><?php echo $lang['download']; ?></a>
              <?php
              }
