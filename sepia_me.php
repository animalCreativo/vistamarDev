    ...
    <section class="section-wrap-mp pad-top-20">
      <div class="container">
        ...
        <div class="vari"><a href="sepia_cs.php"><h4><?php echo $lang['cabernetBlend']; ?></h4></a></div>
              ...
              <div class="dot3">·</div>
              <div class="vari"><a href="sepia_me.php"><h4 style="color: black;"><?php echo $lang['merlot']; ?></h4></a></div>
              </div>
              <div class="contain-1">
        <div class="vari"><a href="sepia_ch.php"><h4><?php echo $lang['chardonnay']; ?></h4></a></div>
            ...
            <div class="info-ow mt-30">
              ...
              <a href="http://www.cavamorande.cl/store/vistamar-sepia-reserva-merlot-2015?search=sepia%20reserva" target="_blank" class="btn btn-lg btn-color">
              <?php echo $lang['buy']; ?></a>
              <?php
              }
              ?> 
